...
#include "hardware/diffdrive_system.hpp"
  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  {
    RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "PID values not supplied, using defaults.");
  }
...
{
  RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "Configuring ...please wait...");
  if (comms_.connected())
  {
    comms_.disconnect();
  }
  comms_.connect(cfg_.device, cfg_.baud_rate, cfg_.timeout_ms);
  RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "Successfully configured!");
...
hardware_interface::CallbackReturn DiffDriveArduino::on_cleanup(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "Cleaning up ...please wait...");
  if (comms_.connected())
  {
    comms_.disconnect();
  }
  RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "Successfully cleaned up!");
...
hardware_interface::CallbackReturn DiffDriveArduino::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "Deactivating ...please wait...");
  RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduino"), "Successfully deactivated!");
